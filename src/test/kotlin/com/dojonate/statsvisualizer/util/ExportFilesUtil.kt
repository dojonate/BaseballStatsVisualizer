...
fun main() {
    val files = listOf(
        "src/main/java/com/dojonate/statsvisualizer/config/SecurityConfig.java",
        ...
        "src/main/java/com/dojonate/statsvisualizer/model/EventType.java",
        "src/main/java/com/dojonate/statsvisualizer/model/FieldConditions.java",
        "src/main/java/com/dojonate/statsvisualizer/model/Game.java",
        "src/main/java/com/dojonate/statsvisualizer/model/GameType.java",
        "src/main/java/com/dojonate/statsvisualizer/model/PitchType.java",
        ...
        "src/main/java/com/dojonate/statsvisualizer/model/PrecipitationType.java",
        ...
        "src/main/java/com/dojonate/statsvisualizer/model/Site.java",
        "src/main/java/com/dojonate/statsvisualizer/model/SkyType.java",
        "src/main/java/com/dojonate/statsvisualizer/model/Team.java",
        "src/main/java/com/dojonate/statsvisualizer/model/WindDirection.java",
        ...
        "src/main/java/com/dojonate/statsvisualizer/repository/SiteRepository.java",
        ...
        "src/main/java/com/dojonate/statsvisualizer/service/SiteService.java",
        ...
        "src/main/java/com/dojonate/statsvisualizer/util/GameState.java",
...
//        "src/test/resources/application-test.properties",
    ...
    println("Consolidated file created at ${outputFile.toAbsolutePath()}")
}